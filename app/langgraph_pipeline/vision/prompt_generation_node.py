...
**프롬프트 작성 예시:**
"TTS 기술 흐름도를 {art_style} 스타일로 그려주세요. 왼쪽에서 오른쪽으로 'Text Input' → 'Gemini API' → 'Audio Output' 순서로 화살표와 함께 배치해주세요. **모든 라벨과 텍스트는 영어로 표기**해주세요. [색상/조명/구도 설명]"
